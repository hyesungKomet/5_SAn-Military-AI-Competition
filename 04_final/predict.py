...
if __name__ == '__main__':
    ...
    #train_config = load_yaml(os.path.join(prj_dir, 'results', 'train', '20221110_023246', 'train.yaml'))
    #! Set predict serial
    pred_serial = config['train_serial'] + '_' + datetime.now().strftime("%Y%m%d_%H%M%S")
    #pred_serial = '20221110_023246'
    ...
    #! Load weight
    check_point_path = os.path.join(prj_dir, 'results', 'train', config['train_serial'], 'model_9.pt')
