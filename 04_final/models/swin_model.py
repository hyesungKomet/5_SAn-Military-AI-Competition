# https://smp.readthedocs.io/en/latest/index.html https://smp.readthedocs.io/en/latest/encoders_timm.html timm encoder 쓸땐 encoder name에 tu- 붙이기 code based on 
...
class SwinEncoder(torch.nn.Module, EncoderMixin):
    def __init__(self, **kwargs):
        ...
        # A number of stages in decoder (in other words number of downsampling operations), integer use in in forward pass to reduce number of returning features
    	self._depth: int = 3
